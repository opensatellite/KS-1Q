...
#define _VOLUME_STRS	"TF","NAND","CF","SD1","SD2","USB1","USB2","USB3"
...
#define _FS_TIMEOUT	(0)	/* Timeout period in unit of time tick */
#define	_SYNC_t		osMutexId       /* O/S dependent sync object type. e.g. HANDLE, OS_EVENT*, ID, SemaphoreHandle_t and etc.. */
